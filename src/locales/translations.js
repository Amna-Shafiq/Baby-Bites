const translations = {
  en: {
    ...
    heroEm:        "confidence",
    heroSub:       "Age-appropriate meals, food guides, and nutrition tips — tailored to every stage of your baby's development.",
  ...
  ur: {
    ...
    heroEm:        "کھلائیں",
    heroSub:       "عمر کے مطابق کھانے، غذائی رہنمائی، اور غذائیت کی تجاویز — آپ کے بچے کی نشوونما کے ہر مرحلے کے لیے۔",
