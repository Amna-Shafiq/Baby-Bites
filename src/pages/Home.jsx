  ...
  return (
    <div className="landing-page">
      <Helmet>
        ...
        <meta name="description" content="Discover 110+ recipes and 170+ food guides organised by age. From 6-month purees to 12-month family meals — Baby Bites makes weaning easy." />
        ...
        <meta property="og:description" content="Discover 110+ recipes and 170+ food guides organised by age. From 6-month purees to 12-month family meals — Baby Bites makes weaning easy." />
        ...
        <meta name="twitter:description" content="Discover 110+ recipes and 170+ food guides organised by age. From 6-month purees to 12-month family meals — Baby Bites makes weaning easy." />
      ...
      <div className="hero-bg">
        ...
        <div className="lp-hero">
          ...
          <div className="lp-stats">
            <div><div className="sn">170+</div><div className="sl">{t("statFoods")}</div></div>
