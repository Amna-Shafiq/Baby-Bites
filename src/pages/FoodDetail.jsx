...
const FOOD_REFERENCES = {
  ...
  "chicken liver":    [SS("chicken-liver")],
  "red lentils":      [SS("red-lentils")],
  "red lentil":       [SS("red-lentils")],
  "green lentils":    [SS("green-lentils")],
  "green lentil":     [SS("green-lentils")],
  "brown lentils":    [SS("brown-lentils")],
